...
(function (ns/*[custom_namespace]*/) {
  ...
  doc = docElm = elmHead = elmBody = elmDiv = sh = ns = null;
  delete doc; delete docElm; delete elmHead; delete elmBody; delete elmDiv; delete sh; delete ns;
