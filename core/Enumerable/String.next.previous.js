...
*/
  ...
  var
    ...
    previousCharacter = (function (from_char_code, parse_int, is_finite, UNDEFINED_VALUE) {
      return function () {
        ...
        //len = currVal.length,
          prevVal
        ;
      //if (len == 0) {       // there is nothing like a "next" character that could be a successor of an empty string.
        if (currVal === "") { // there is nothing like a "next" character that could be a successor of an empty string.

          prevVal = UNDEFINED_VALUE;

      //} else if (len == 1) {            // this definitely is a character.
        } else if (currVal.length == 1) { // this definitely is a character.

          prevVal = from_char_code(currVal.charCodeAt(0) - 1);
      /*
       *  either "prevVal" gets assigned a valid character ...
       *  ... or assignement of "prevVal" falls back again to [undefined].
       */
        //prevVal = ((prevVal.length == 1) && (prevVal !== currVal)) ? prevVal : UNDEFINED_VALUE;
          ...
          prevVal = (currVal - 1);
      /*
       *  either "prevVal" gets assigned a valid integer ...
       *  ... or assignement of "prevVal" falls back again to [undefined].
       */
          prevVal = (is_finite(prevVal) && (prevVal !== currVal)) ? prevVal : UNDEFINED_VALUE;
        }
        return prevVal;
      };
    }(fromCharCode, parseInt, isFinite)),
...
- Whitespace only - 1.588 byte
(function(){var global=this,Str=global.String,fromCharCode=Str.fromCharCode,parseInt=global.parseInt,isFinite=global.isFinite,isFunction=typeof global.isFunction=="function"&&global.isFunction(global.isFunction)&&global.isFunction||function(obj){return typeof obj=="function"&&typeof obj.call=="function"&&typeof obj.apply=="function"},Enumerable=isFunction(global.require)&&global.require("Enumerable")||global["Enumerable"];var nextCharacter=function(from_char_code,parse_int,is_finite,UNDEFINED_VALUE){return function(){var currVal=""+this,nextVal;if(currVal==="")nextVal=UNDEFINED_VALUE;else if(currVal.length==1){nextVal=from_char_code(currVal.charCodeAt(0)+1);nextVal=nextVal!==""&&nextVal!==currVal?nextVal:UNDEFINED_VALUE}else{currVal=parse_int(this,10);nextVal=currVal+1;nextVal=is_finite(nextVal)&&nextVal!==currVal?nextVal:UNDEFINED_VALUE}return nextVal}}(fromCharCode,parseInt,isFinite),previousCharacter=function(from_char_code,parse_int,is_finite,UNDEFINED_VALUE){return function(){var currVal=""+this,prevVal;if(currVal==="")prevVal=UNDEFINED_VALUE;else if(currVal.length==1){prevVal=from_char_code(currVal.charCodeAt(0)-1);prevVal=prevVal!==""&&prevVal!==currVal?prevVal:UNDEFINED_VALUE}else{currVal=parse_int(this,10);prevVal=currVal-1;prevVal=is_finite(prevVal)&&prevVal!==currVal?prevVal:UNDEFINED_VALUE}return prevVal}}(fromCharCode,parseInt,isFinite),compare=function(a,b){return a<b&&-1||a>b&&1||0},EnumerableCharacter=Enumerable.create({next:nextCharacter,previous:previousCharacter,compare:compare});EnumerableCharacter.call(Str.prototype);return Str}).call(null);


- Simple          -   755 byte
(function(){var c=this.String,d=c.fromCharCode,e=this.parseInt,f=this.isFinite;(("function"==typeof this.isFunction&&this.isFunction(this.isFunction)&&this.isFunction||function(b){return"function"==typeof b&&"function"==typeof b.call&&"function"==typeof b.apply})(this.require)&&this.require("Enumerable")||this.Enumerable).create({next:function(){var b=""+this,a;""===b?a=void 0:1==b.length?(a=d(b.charCodeAt(0)+1),a=""!==a&&a!==b?a:void 0):(b=e(this,10),a=b+1,a=f(a)&&a!==b?a:void 0);return a},previous:function(){var b=""+this,a;""===b?a=void 0:1==b.length?(a=d(b.charCodeAt(0)-1),a=""!==a&&a!==b?a:void 0):(b=e(this,10),a=b-1,a=f(a)&&a!==b?a:void 0);return a},compare:function(b,a){return b<a&&-1||b>a&&1||0}}).call(c.prototype);return c}).call(null);
