...
//module base [Array.ecma5.generic] - 4.010 byte
(function(){var k=this&&this.window===this&&window||this,i=k.Array,j=i.prototype,n=typeof k.isFunction=="function"&&k.isFunction||function(f){return typeof f=="function"};if(!i||!n(i.isArray)||!n(i.make))throw new ReferenceError("All [[Array]] implementations badly require the presence of the [[Array]] extensions module base [Array.make.detect].");j.forEach=function(){var f=i.isArray,g=i.make;return function(e,a){var b=f(this)&&this||g(this);if(b&&typeof e=="function"){a=typeof a=="undefined"||typeof a=="obj"&&!a?null:a;for(var c,d=-1,h=b.length;++d<h;){c=b[d];if(typeof c!="undefined"||d in b)e.call(a,c,d,b)}}}}();i.forEach=function(){var f=j.forEach;return function(g,e,a){f.call(g,e,a)}}();j.every=function(){var f=i.isArray,g=i.make;return function(e,a){var b,c=f(this)&&this||g(this);if(c&&typeof e=="function"){var d,h=-1,l=c.length,m=false;if(l>=1){a=typeof a=="undefined"||typeof a=="obj"&&!a?null:a;for(b=true;b&&++h<l;){d=c[h];if(typeof d!="undefined"||h in c){m=true;b=e.call(a,d,h,c)}}b=m&&b}}return!!b}}();i.every=function(){var f=j.every;return function(g,e,a){return f.call(g,e,a)}}();j.some=function(){var f=i.isArray,g=i.make;return function(e,a){var b,c=f(this)&&this||g(this);if(c&&typeof e=="function"){var d,h=-1,l=c.length,m=false;if(l>=1){a=typeof a=="undefined"||typeof a=="obj"&&!a?null:a;for(b=false;!b&&++h<l;){d=c[h];if(typeof d!="undefined"||h in c){m=true;b=e.call(a,d,h,c)}}b=m&&b}}return!!b}}();i.some=function(){var f=j.some;return function(g,e,a){return f.call(g,e,a)}}();j.map=function(){var f=i.isArray,g=i.make;return function(e,a){var b=[],c=f(this)&&this||g(this);if(c&&typeof e=="function"){a=typeof a=="undefined"||typeof a=="obj"&&!a?null:a;for(var d,h=-1,l=c.length;++h<l;){d=c[h];b[h]=typeof d!="undefined"||h in c?e.call(a,d,h,c):d}}return b}}();i.map=function(){var f=j.map;return function(g,e,a){return f.call(g,e,a)}}();j.filter=function(){var f=i.isArray,g=i.make;return function(e,a){var b=[],c=f(this)&&this||g(this);if(c&&typeof e=="function"){a=typeof a=="undefined"||typeof a=="obj"&&!a?null:a;for(var d,h=-1,l=c.length;++h<l;){d=c[h];if(typeof d!="undefined"||h in c)e.call(a,d,h,c)&&b.push(d)}}return b}}();i.filter=function(){var f=j.filter;return function(g,e,a){return f.call(g,e,a)}}();j.reduce=function(){var f=i.isArray,g=i.make;return function(e,a){var b=f(this)&&this||g(this);if(b&&typeof e=="function"){var c,d=0,h=b.length;c=typeof a!="undefined";if(h!==0||c){if(!c){do{c=b[d];if(typeof c!="undefined"||d in b){a=c;++d;break}if(++d>=h)break}while(1)}for(;d<h;){c=b[d];if(typeof c!="undefined"||d in b)a=e.call(null,a,c,d,b);++d}}else a=void 0}else a=void 0;return a}}();i.reduce=function(){var f=j.reduce;return function(g,e,a){return f.call(g,e,a)}}();j.reduceRight=function(){var f=i.isArray,g=i.make;return function(e,a){var b=f(this)&&this||g(this);if(b&&typeof e=="function"){var c;c=b.length;var d=c-1,h=typeof a!="undefined";if(c!==0||h){if(!h){do{c=b[d];if(typeof c!="undefined"||d in b){a=c;--d;break}if(--d<0)break}while(1)}for(;d>=0;){c=b[d];if(typeof c!="undefined"||d in b)a=e.call(null,a,c,d,b);--d}}else a=void 0}else a=void 0;return a}}();i.reduceRight=function(){var f=j.reduceRight;return function(g,e,a){return f.call(g,e,a)}}();j.indexOf=function(){var f=i.isArray,g=i.make;return function(e,a){var b,c,d,h=f(this)&&this||g(this);if(h){b=h.length;a=k.parseInt(k.Number(a),10);a=k.isFinite(a)&&a||0;for(a=a<0&&k.Math.max(0,b+a)||a;a<b;){c=h[a];if((typeof c!="undefined"||a in h)&&c===e){d=true;break}++a}}return d?a:-1}}();i.indexOf=function(){var f=j.indexOf;return function(g,e,a){return f.call(g,e,a)}}();j.lastIndexOf=function(){var f=i.isArray,g=i.make;return function(e,a){var b,c,d=f(this)&&this||g(this);if(d){b=d.length;a=k.parseInt(k.Number(a),10);a=k.isFinite(a)&&a||b;a=a<0&&k.Math.max(0,b+a)||a;for(a=a>=b&&b-1||a;a>-1;){b=d[a];if((typeof b!="undefined"||a in d)&&b===e){c=true;break}--a}}return c?a:-1}}();i.lastIndexOf=function(){var f=j.lastIndexOf;return function(g,e,a){return f.call(g,e,a)}}()})();
