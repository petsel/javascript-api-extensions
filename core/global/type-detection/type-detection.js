...
//exposeImplementation.call(undefined); // [object builtins] - google chrome and safari only
  ...
  Obj.getBaseName = (function () {

    var getBaseName = ObjProto.getBaseName, global = sh;
    return (function (obj/*:[object|value]*/) {
...
*/
  ...
  ObjProto.getBase = (function () { // or [getBaseType] or even more precisely [getBaseTypeOrValue]
  ...
  Obj.getBase = (function () { // or [getBaseType] or even more precisely [getBaseTypeOrValue]

    var getBase = ObjProto.getBase, global = sh;
    return (function (obj/*:[object|value]*/) {
...
*/
  ...
  exposeErrorImplementation = exposeImplementation = regXClassName = ObjProto = Obj = sh = null;
  delete exposeErrorImplementation; delete exposeImplementation;
  delete regXClassName; delete ObjProto; delete Obj; delete sh;
